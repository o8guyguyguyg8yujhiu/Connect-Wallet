...
const ConnectWallet: React.FC = () => {
  ...
  const checkWalletStatus = async (telegramId: number) => {
    try {
      console.log("Checking wallet status for:", telegramId);
      ...
      const data = await response.json();
      console.log("Wallet status fetched:", data.wallet_status);
      ...
      <div className="container">
        ...
        {!address ? (
          ...
          <div className="connected-info">
            ...
            <p className="connected-text">
              Wallet status: <strong>{walletStatus || "Checking..."}</strong>
            </p>
